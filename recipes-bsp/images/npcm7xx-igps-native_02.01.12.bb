...
SRC_URI = " \
    git://github.com/Nuvoton-Israel/igps;protocol=git \
...
DEST = "${D}${datadir}/npcm7xx-igps"

do_install() {
	install -d ${DEST}
	install ImageGeneration/references/BootBlockAndHeader_EB.xml ${DEST}
	install ImageGeneration/references/UbootHeader_EB.xml ${DEST}
